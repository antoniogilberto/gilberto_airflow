...
def extract_orders():
    """
    A função tem a finalidade de extrair todos os dados da tabela "Order" do banco de dados SQLite "sqlite" 
    e salvá-los em um arquivo CSV com o nome "output_orders.csv"..
    """
